...
class HarcamaGruplariChart extends StatelessWidget {
  final List<HarcamaGrubuData> data;

  const HarcamaGruplariChart({
    super.key,
    required this.data,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Harcama Grupları Değişim Oranları (%)',
            style: TextStyle(
              fontSize: 16,
  ...
  Widget _buildBarItem(
      HarcamaGrubuData item, double maxValue, BuildContext context) {
